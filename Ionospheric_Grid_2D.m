...
num_range = 1001;
num_heights = 1000;
max_range = 20000; % maximum group range for data grids (Km) (SEE IMPORTANT NOTE ABOVE)
...
height_inc = 5; % desired height step of iono_pf_grid & bfield grids (km) (SEE IMPORTANT NOTE ABOVE)
